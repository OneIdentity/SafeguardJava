...
public class HttpHubConnectionBuilder {
    ...
    HttpHubConnectionBuilder(String url, boolean ignoreSsl) {
        this(url);
    ...
    public HubConnection build() {
        return new HubConnection(url, transport, skipNegotiate, httpClient, accessTokenProvider, handshakeResponseTimeout, headers, ignoreSsl);
    }
}
