...
public final class Safeguard {
    ...
    public static ISafeguardConnection connect(String networkAddress, char[] accessToken,
            Integer apiVersion, Boolean ignoreSsl) throws ArgumentException, SafeguardForJavaException {
    ...
    public static class Event {
         ...
         * @throws ArgumentException Invalid argument. exception.
         */
    ...
    public static class A2A {
        ...
        public static ISafeguardA2AContext getContext(String networkAddress, String certificatePath,
                char[] certificatePassword, Integer apiVersion, Boolean ignoreSsl) throws SafeguardForJavaException {
            int version = DEFAULTAPIVERSION;
            if (apiVersion != null) {
                version = apiVersion;
            }
        ...
        public static class Event {
             ...
             * supported in A2A.
             *
             * @param apiKeys A list of API keys corresponding to the configured
             * accounts to listen for.
             * @param handler A delegate to call any time the
             * AssetAccountPasswordUpdate event occurs.
             * @param networkAddress Network address of Safeguard appliance.
             * @param keystorePath Path to the keystore containing the client
             ...
             * supported in A2A.
             *
             * @param apiKeys A list of API key corresponding to the configured
             * accounts to listen for.
             * @param handler A delegate to call any time the
             * AssetAccountPasswordUpdate event occurs.
             * @param networkAddress Network address of Safeguard appliance.
